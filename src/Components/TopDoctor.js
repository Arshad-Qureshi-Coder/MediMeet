...
class="py-2.5 px-6 text-sm rounded-full bg-gradient-to-br from-violet-600 to-teal-400 text-white cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-gradient-to-tr ">
  more
        ...
        <button onClick={() => {
          ...
          class="text-base font-semibold m-6 group relative w-max p-2 rounded-full border border-customGreen shadow-md shadow-customGreen/50 overflow-hidden">
          <span class="px-1 relative z-10 group-hover:text-white">more</span>
          <span class="absolute left-0 bottom-0 w-full h-full bg-customGreen z-0 transition-all duration-300 rounded-full scale-0 group-hover:scale-100"></span>
        </button>
